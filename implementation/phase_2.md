...
## Overview
Traditional parsers can be bottlenecked by inline scope crawling and jumping around the filesystem via imports. Walk does this as a flat operations map, evalutating individual file contents as isolated Micro-ASTs.
