...
Walk enforces explicit composition. THere is no implicit delegation. When the compiler evaluates "user.wallet.pay()", it does zero graph searching. It explicity checks the "models/wallet" directory for "pay.met" and validates the contract.
